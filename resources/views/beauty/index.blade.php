...
<div class="col">
    <h2 class="pb-2 border-bottom">Beauty & Skincare
    ...
    <br>
        <form class="row" method="GET" action="{{url('/beauty')}}">
        ...
        <div class="row align-items-start">
            @foreach ($beauty as $bty)
            <div class="col">
                <div class="card" style="width: 15rem;">
                    <img src="{{$bty->foto}}" class="card-img-top" alt="..." style="height: 13rem">
                    <div class="card-body">
                    <h5 class="card-title">{{$bty->nama}}</h5>
                    <p class="card-text">Rp. {{$bty->harga}}</p>
