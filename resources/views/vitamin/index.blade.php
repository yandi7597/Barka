...
<div class="col">
    <h2 class="pb-2 border-bottom">Vitamin Supplement
    ...
    <br>
        <form class="row" method="GET" action="{{url('/vitamin')}}">
        ...
        <div class="row align-items-start">
            ...
            <div class="col">
                <div class="card" style="width: 15rem;">
                    <img src="{{$vit->foto}}" class="card-img-top" alt="..." style="height: 13rem">
                    <div class="card-body">
                    <h5 class="card-title">{{$vit->nama}}</h5>
                    <p class="card-text">Rp. {{$vit->harga}}</p>
