...
<div class="col">
    <h2 class="pb-2 border-bottom">Obat Herbal
    ...
    <br>
        <form class="row" method="GET" action="{{url('/obatherbal')}}">
        ...
        <div class="row align-items-start">
            @foreach ($obatherbal as $oh)
            <div class="col">
                <div class="card" style="width: 15rem;">
                    <img src="{{$oh->foto}}" class="card-img-top" alt="..." style="height: 13rem">
                    <div class="card-body">
                    <h5 class="card-title">{{$oh->nama}}</h5>
                    <p class="card-text">Rp. {{$oh->harga}}</p>
